...
//           validUserMessages.push({ role: "user", ...message });
//         } catch (error) {
...
//       console.log("Received partial object:", obj);
//       if (obj.items) {
//         objectStream.update(obj)
//         finalRelatedQueries = obj
//       }
//       else if (obj.related) {
//         // Ensure finalRelatedQueries.items is initialized
//         if (!finalRelatedQueries.items) {
//           finalRelatedQueries.items = [];
//         }

//         // Transform the 'related' array into the required format
//         const relatedQueries = obj.related.map(query => ({ query }));
//         finalRelatedQueries.items = finalRelatedQueries.items.concat(relatedQueries); // Concatenate safely
//       }
//       else {
//         console.log("No 'items' in the received object:", obj);
//       }
//     }

//     console.log("All partial objects received.");
//   } catch (error) {
