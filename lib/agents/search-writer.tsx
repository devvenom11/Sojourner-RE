...
// console.log("Messages",messages);
  ...
  If user greeting or casual conversation, then generate a friendly detailed and engaging greeting response. Also include a friendly and engaging response if the user has provided a casual conversation.
